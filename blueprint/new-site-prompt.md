...
The reference implementation is `sites/phils-auto-v2/` (Astro 5, plain CSS, video hero, GSAP/Lenis,
...
1. `cp -r sites/phils-auto-v2 sites/<slug>`; clear `node_modules`, `dist`, `dist-preview`, `public/assets/og`.
