  ...
  const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><style>
    *{box-sizing:border-box;margin:0}
    body{width:${W}px;height:${H}px;overflow:hidden;position:relative;
      background:linear-gradient(158deg,#0b0f0b 0%,#1b241b 46%,#070a07 100%)}
    ...
    .truss i{position:absolute;display:block;height:2px;background:#80d850;transform-origin:left}
