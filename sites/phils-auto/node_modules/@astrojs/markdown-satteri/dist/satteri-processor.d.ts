import type { Features, HastNode, HastPluginDefinition, HastPluginEntry, HastPluginList, MdastPluginDefinition, MdastPluginList } from 'satteri';
...
export declare function createHeadingIdsPlugin(): HastPluginEntry;
