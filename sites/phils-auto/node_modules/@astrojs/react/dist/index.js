...
function getViteConfiguration({
  ...
  const mergedExclude = exclude ? Array.isArray(exclude) ? [...exclude, ...defaultExclude] : [exclude, ...defaultExclude] : defaultExclude;
  return {
    plugins: [
...
function index_default(options = {}) {
  ...
  const { include, exclude, compiler, experimentalReactChildren, experimentalDisableStreaming } = options;
