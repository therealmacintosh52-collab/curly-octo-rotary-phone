...
export function waitForNetworkIdle(session: LH.Gatherer.ProtocolSession, networkMonitor: NetworkMonitor, networkQuietOptions: {
    ...
    pretendDCLAlreadyFired?: boolean;
}): CancellableWait;
/**
 ...
 */
export function waitForFullyLoaded(session: LH.Gatherer.ProtocolSession, networkMonitor: NetworkMonitor, options: WaitOptions, signal?: AbortSignal): Promise<{
    timedOut: boolean;
}>;
/**
