...
function getRequestSpanData(span) {
  ...
  try {
    if (typeof maybeUrlAttribute === "string") {
      ...
      const query = core.filterCollectedUrlQuery(url.search);
      if (query) {
...
function descriptionForHttpMethod({ name, kind, attributes }, httpMethod) {
  ...
  const data = {};
  if (url) {
    data.url = core.filterCollectedUrl(url);
  }
  const filteredQuery = core.filterCollectedUrlQuery(query);
  if (filteredQuery) {
...
//# sourceMappingURL=asyncContextStrategy-BR-l9zjD.js.map
