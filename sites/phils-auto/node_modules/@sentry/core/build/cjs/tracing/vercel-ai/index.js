...
const CLIENTS_WITH_VERCEL_AI_PROCESSORS = /* @__PURE__ */ new WeakSet();
...
function getProviderMetadataAttributes(providerMetadata) {
  ...
  if (googleUsage && typeof googleUsage.thoughtsTokenCount === "number" && googleUsage.thoughtsTokenCount > 0) {
    attributes[genAiAttributes.GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE] = (googleUsage.candidatesTokenCount ?? 0) + googleUsage.thoughtsTokenCount;
    setAttributeIfDefined(attributes, genAiAttributes.GEN_AI_USAGE_TOTAL_TOKENS_ATTRIBUTE, googleUsage.totalTokenCount);
    setAttributeIfDefined(attributes, "gen_ai.usage.reasoning.output_tokens", googleUsage.thoughtsTokenCount);
  }
  return attributes;
}
const LAST_STEP_ONLY_USAGE_KEYS = /* @__PURE__ */ new Set([
  genAiAttributes.GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE,
  genAiAttributes.GEN_AI_USAGE_TOTAL_TOKENS_ATTRIBUTE,
...
function addProviderMetadataToAttributes(attributes) {
  ...
  const lastStepOnly = attributes[genAiAttributes.GEN_AI_OPERATION_NAME_ATTRIBUTE] === "invoke_agent";
  try {
...
exports.LAST_STEP_ONLY_USAGE_KEYS = LAST_STEP_ONLY_USAGE_KEYS;
