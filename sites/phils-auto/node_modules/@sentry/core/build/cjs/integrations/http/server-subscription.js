      ...
      return trace.startSpanManual(
        {
          ...
          attributes: {
            ...
            [attributes.URL_FULL]: urlObj && !url.isURLObjectRelative(urlObj) ? filterCollectedUrl.filterCollectedUrl(urlObj.href, client) : void 0,
            [attributes.URL_PATH]: urlObj?.pathname ?? httpTargetWithoutQueryFragment,
            // oxlint-disable-next-line typescript-eslint(no-deprecated)
            [attributes.HTTP_URL]: filterCollectedUrl.filterCollectedUrl(fullUrl, client),
            "http.method": method,
            "http.target": filterCollectedUrl.filterCollectedUrl(
