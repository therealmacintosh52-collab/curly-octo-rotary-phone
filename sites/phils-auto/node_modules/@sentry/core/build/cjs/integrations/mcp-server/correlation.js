...
function completeSpanWithResults(transport, requestId, result, hasError = false) {
  ...
  if (spanData) {
    ...
    if (hasError) {
      ...
      const toolAttributes = resultExtraction.extractToolResultAttributes(result, spanData.capturePolicy.recordOutputs);
      span.setAttributes(toolAttributes);
    } else if (method === "prompts/get") {
      const promptAttributes = resultExtraction.extractPromptResultAttributes(result, spanData.capturePolicy.recordOutputs);
