...
function getHttpSpanDetailsFromUrlObject(urlObject, kind, spanOrigin, request, routeName, client) {
  ...
  if (urlObject) {
    if (urlObject.search) {
      attributes$1["url.query"] = filterCollectedUrl.filterCollectedUrlQuery(urlObject.search, client);
    }
    if (urlObject.hash) {
    ...
    if (!isURLObjectRelative(urlObject)) {
      attributes$1[attributes.URL_FULL] = filterCollectedUrl.filterCollectedUrl(urlObject.href, client);
      if (urlObject.port) {
