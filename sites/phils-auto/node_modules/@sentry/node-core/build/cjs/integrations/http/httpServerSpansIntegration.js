        ...
        const startSpan = (next) => {
          ...
          const span = core.startInactiveSpan({
            ...
            attributes: {
              ...
              [attributes.URL_FULL]: urlObj && !core.isURLObjectRelative(urlObj) ? core.filterCollectedUrl(urlObj.href, client) : void 0,
              ...
              [attributes.HTTP_URL]: core.filterCollectedUrl(fullUrl, client),
              [attributes.HTTP_METHOD]: normalizedRequest.method,
              [attributes.HTTP_TARGET]: core.filterCollectedUrl(
