...
import { SDK_VERSION, getClient, instrumentStateGraph, instrumentCreateReactAgent } from '@sentry/core';
...
class SentryLangGraphInstrumentation extends InstrumentationBase {
  ...
  _patch(exports) {
    ...
    if (exports.StateGraph && typeof exports.StateGraph === "function") {
      instrumentStateGraph(exports.StateGraph.prototype, options);
    }
