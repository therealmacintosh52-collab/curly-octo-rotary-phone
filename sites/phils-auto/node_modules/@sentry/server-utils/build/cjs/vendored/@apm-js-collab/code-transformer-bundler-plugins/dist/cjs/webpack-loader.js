...
require('./chunk-D6vf50IK.js');
require('./instrumentation-serde-BFky_HG6.js');
...
const chunkD6vf50IK = require('../../../../../_virtual/chunk-D6vf50IK.js');
const instrumentationSerdeBFky_HG6 = require('../../../../../_virtual/instrumentation-serde-BFky_HG6.js');

const require_chunk = chunkD6vf50IK.__exports;
const require_instrumentation_serde = instrumentationSerdeBFky_HG6.__exports;
let _apm_js_collab_code_transformer = index$1.codeTransformer;
let path = require$$0;
let fs = require$$4;
let module_details_from_path = index.moduleDetailsFromPath;
...
//#endregion
var webpackLoader = codeTransformerLoader;



const codeTransformerLoaderImpl = /*@__PURE__*/_commonjsHelpers.getDefaultExportFromCjs(webpackLoader);

exports.default = codeTransformerLoaderImpl;
