...
const transforms$1 = require('../../../../_virtual/transforms.js');
const esquery_esm_min = require('../../../esquery/dist/esquery.esm.min.js');
require('../../../meriyah/dist/meriyah2.js');
const meriyah = require('../../../../_virtual/meriyah.js');
...
function wrapParams(params) {
  ...
  const numberedParams = originalParams.filter((param) => param.type !== "RestElement" && param.type !== "AssignmentPattern").map((_, i) => ({ type: "Identifier", name: `__apm$arg${i}` }));
  return [
    ...numberedParams,
...
exports.transformsExports = transformsExports;
