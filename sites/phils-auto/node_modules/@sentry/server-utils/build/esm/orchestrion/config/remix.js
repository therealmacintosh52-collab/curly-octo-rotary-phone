...
const remixConfig = ["dist", "dist/esm"].flatMap(remixInstrumentationConfig);
const remixChannels = {
...
const remixSubscribeInjection = toSubscribeInjections(remixConfig);

export { remixChannels, remixConfig, remixSubscribeInjection };
