import createDebug from '../../debug/src/node.js';
import { c as codeTransformer } from '../code-transformer/index.js';
import parse from '../../module-details-from-path/index.js';
import { fileURLToPath } from 'node:url';
import { MessageChannel } from 'node:worker_threads';
import getPackageVersion from './lib/get-package-version.js';
import { d as diagnostics } from './lib/diagnostics.js';
...
let emit = diagnostics.emitDiagnostics;
...
const setDiagnosticsHook = diagnostics.setDiagnosticsHook;
export { createDiagnosticsPort, initialize, initializeSync, load, loadResult, loadSync, resolve, resolveSync, setDiagnosticsHook };
