...
import parse$1 from '../../../../module-details-from-path/index.js';
...
function createCodeTransformer(options) {
	const matcher = codeTransformer.create(options.instrumentations, options.dcModule ?? null);
	...
	const transform = (code, id, inputSourceMap) => {
		const moduleDetails = parse$1(id);
...
//# sourceMappingURL=core-dC9TN3Ev.js.map
