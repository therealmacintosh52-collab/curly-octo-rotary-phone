 ...
 *
 */
export declare function computePathnameFromDomain(request: Request, url: URL, i18n: SSRManifest['i18n'], base: SSRManifest['base'], trailingSlash: SSRManifest['trailingSlash'], allowedDomains: SSRManifest['allowedDomains'], logger: AstroLogger, pathnameFromRequest?: string): string | undefined;
