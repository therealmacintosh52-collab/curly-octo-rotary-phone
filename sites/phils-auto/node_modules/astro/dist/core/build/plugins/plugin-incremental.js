...
function hashModules(graph, sortedIds, compiledCss) {
...
function createTransitiveGraphCache(graph, compiledCss = /* @__PURE__ */ new Map()) {
...
function pluginIncremental(internals, root) {
  const compiledCss = /* @__PURE__ */ new Map();
  return {
    ...
    transform(code, id) {
      if (this.environment?.name === ASTRO_VITE_ENVIRONMENT_NAMES.prerender && CSS_LANGS_RE.test(id)) {
