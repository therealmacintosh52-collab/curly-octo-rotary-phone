 ...
 *{box-sizing:border-box;margin:0}
 ...
 .chip img{height:58px;display:block}
 .eyebrow{display:block;font-size:19px;font-weight:800;letter-spacing:.17em;
   text-transform:uppercase;color:#ff9455;margin-bottom:16px}
 ...
 .meta span{display:block;font-size:18px;color:#c3cbe8;margin-top:5px}
