...
--   addon   – anything extra (add in Settings → Services)
insert into public.services (id, company_id, name, description, category, default_price, sort_order)
values
  ('00000000-0000-4000-8000-000000000204', '00000000-0000-4000-8000-000000000001', 'PDI',                   'New car pre-delivery inspection prep',       'new',     60.00, 10),
  ('00000000-0000-4000-8000-000000000209', '00000000-0000-4000-8000-000000000001', 'Sold',                  'Delivery clean on a sold unit',              'new',     20.00, 20),
  ('00000000-0000-4000-8000-000000000201', '00000000-0000-4000-8000-000000000001', 'Used',                  'Used car full detail',                       'used',   200.00, 30),
  ('00000000-0000-4000-8000-000000000202', '00000000-0000-4000-8000-000000000001', 'Service Loaner Detail', 'Full detail on a service loaner',            'service', 125.00, 40)
on conflict (id) do nothing;
