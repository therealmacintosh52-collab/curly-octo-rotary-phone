...
export default function DevJobsPreview() {
  ...
  const profile = { id: "u1", company_id: "c1", role: "owner", full_name: "Vincent (preview)", email: null, active: true } as Profile;
            ...
            <div className="mt-5 flex flex-col gap-4">
              <Suspense>
                <JobsFilters
                  ...
                  services={[{ id: "s1", name: "Full Detail" }, { id: "s2", name: "Delivery Prep" }]}
              ...
              <Card>
                ...
                <CardContent><AuditTimeline entries={audit} actorNames={{ u1: "Vincent", u2: "Marco R." }} /></CardContent>
              </Card>
            </div>
          </Page>
        </AppShell>
